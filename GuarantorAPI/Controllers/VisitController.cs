...
namespace GuarantorAPI.Controllers
{
    ...
    public class VisitController : ControllerBase
    {
        ...
        public IActionResult GetVisitsByCustomerId(string customerId)
        {
            var result = _visitAdapter.GetVisitsByCustomerId(customerId);
            if (result.StatusCode == HttpStatusCode.OK)
            {
                return Ok(result.Result);
            }
        ...
        {
            var result = _visitAdapter.RemoveVisit(id);
